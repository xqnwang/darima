...
robjects.r.source(os.path.dirname(os.path.abspath(__file__)) + "/R/test_fun.R", verbose=False)
...
robjects.r.source(os.path.dirname(os.path.abspath(__file__)) + "/R/sarima2ar_model.R", verbose=False)
